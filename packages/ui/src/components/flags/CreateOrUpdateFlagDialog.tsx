...
export const CreateOrUpdateFlagDialog: React.FC<
    ...
    const deleteFlagProps: ConfirmationDialogProps = {
        ...
        description: (
            <>
                ...
                <div>
                    Any subsequent API call will return with a{" "}
                    <code>NotFound (404)</code> error.
                </div>
            </>
        ),
        icon: (
                                                    ...
                                                    <div className="divide-y divide-gray-200 px-4 sm:px-6">
                                                        ...
                                                        <div className="pb-6 pt-4">
                                                            <div className="mt-4 flex text-base">
                                                                <a
                                                                    href="https://docs.switchfeat.com/concepts/flags"
                                                                    target="_blank"
                                                                    rel="noreferrer"
