...
export const ConditionsItem: React.FC<{
                ...
                <div className="flex">
                    <div className="text-base  leading-6 text-gray-900 ">
                        <span className="font-semibold">
                            {props.condition.context}
                        </span>
                    </div>
                    <div className="ml-4">{props.condition.operator}</div>
                    <div className="ml-4">{props.condition.value}</div>
                </div>
                <button
                    type="button"
