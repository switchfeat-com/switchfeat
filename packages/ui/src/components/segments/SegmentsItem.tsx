...
} from "./CreateOrUpdateSegmentDialog";

export const SegmentsItem: React.FC<{
                ...
                <div className="px-4 py-5 sm:p-6  flex justify-between w-full ">
                    <div className="text-base text-gray-500">
                        <div className="text-lg text-left  leading-6 text-gray-900">
                            ...
                            <span>( {props.segment.description} )</span>
                        </div>
                    ...
                    <div>
                        <div>
                            <code className="bg-slate-100 px-2 py-1 rounded-md text-base ml-4">
                                {props.segment.conditions.length} conditions
                            </code>
                        </div>
                        <div className="mt-4">
                            <code className="bg-green-100 px-2 py-1 rounded-md text-base ml-4">
