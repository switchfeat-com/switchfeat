        ...
        <div className="text-center border-4 border-dashed p-10 m-10">
           <FolderPlusIcon className="h-10 w-10 mx-auto text-gray-400"/>
            ...
            <p className="mt-1 text-base text-gray-500">
                {props.type === "flags" && `Get started by creating a new feature flag.`}
                {props.type === "segments" && `Get started by creating a new user segment.`}
                {props.type === "conditions" && `Get started by creating a new condition.`}
            </p>
            <div className="mt-6">
               {props.children}
            </div>
